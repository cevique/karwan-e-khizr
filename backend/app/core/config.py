...
class Settings(BaseSettings):
    ...
    REQUEST1_GEMINI_MODEL: str = Field(default="gemini-3.6-flash", description="Gemini model for Request #1")
    ...
    REQUEST1_GROQ_MODEL: str = Field(default="openai/gpt-oss-120b", description="Groq model for Request #1")
    ...
    REQUEST2_GEMINI_MODEL: str = Field(default="gemini-3.6-flash", description="Gemini model for Request #2")
    ...
    REQUEST2_GROQ_MODEL: str = Field(default="openai/gpt-oss-120b", description="Groq model for Request #2")
